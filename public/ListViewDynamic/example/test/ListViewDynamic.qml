...
ListView {
    ...
    header : Column{
        ...
        function setState(name){
            if (name === '')           {imgHead.source = './ListViewDynamic/images/arrow-down-24.png'; txtHeader.text=qsTr("下拉可以刷新");}
            else if (name === 'ready') {imgHead.source = './ListViewDynamic/images/arrow-up-24.png';   txtHeader.text=qsTr("放开即可刷新");}
            else if (name === 'load')  {imgHead.source = './ListViewDynamic/images/loading-32.gif';    txtHeader.text=qsTr("加载中");}
            else if (name === 'ok')    {imgHead.source = './ListViewDynamic/images/ok-24.png';         txtHeader.text=qsTr("下拉刷新");
    ...
    footer: Column{
        ...
        function setState(name){
            if (name === '')           {imgFoot.source = './ListViewDynamic/images/arrow-down-24.png'; txtFoot.text = qsTr("上拉可以刷新");}
            else if (name === 'ready') {imgFoot.source = './ListViewDynamic/images/arrow-up-24.png';   txtFoot.text = qsTr("放开即可刷新");}
            else if (name === 'load')  {imgFoot.source = './ListViewDynamic/images/loading-32.gif';    txtFoot.text = qsTr("加载中");}
            else if (name === 'ok')    {imgFoot.source = './ListViewDynamic/images/ok-24.png';         txtFoot.text = qsTr("上拉刷新");
    ...
    onMovementEnded: {
        ...
        // 加载新数据
            ...
            if( contentY < __.topLoaderPos ){
                __.moveToHeader();
            }else if( contentY > __.bottomLoaderPos ){
                __.moveToFooter()
            }
